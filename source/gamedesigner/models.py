    ...
    production = Node(
        ...
        fields=[
            _visual_field(
                "原生分辨率",
                "长文本",
                "先生成最终尺寸的 3x 或 4x 清晰源图，再用本地多候选缩小/Aseprite 候选做粗像素稿，最后让 AI 参考最佳候选重绘为原生像素稿。禁止把马赛克滤镜或粗缩小图当最终稿；不要牺牲脸部、服装和道具细节。",
                16,
                16,
                512,
                118,
            ...
            _visual_field(
                "调色板",
                "长文本",
                "调色板要受控但不硬压低色数；每条色阶 3-5 档，暗部允许轻微冷暖偏移。避免照片级渐变、过多相近色和自动抗锯齿产生的新颜色，但保留高品质角色/材质所需的关键颜色。",
                16,
                148,
                512,
                118,
    ...
    pixel_perfect = Node(
        ...
        fields=[
            _visual_field(
                "线条规则",
                "长文本",
                "使用 1px 硬边铅笔感线条；斜线和曲线要有规律的阶梯长度；清除 L 形拐角中多余的夹心像素；避免双宽斜线、毛刺、孤立噪点、随机单点高光、1-2 像素边缘碎片和不受控抖动。",
                16,
                16,
                512,
                130,
